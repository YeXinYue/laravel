...
Route::prefix('/zhubao')->group(function(){
    ...
    //订单支付
    Route::any('/alipay/{order_id}','Index\RegController@alipay');
    //支付同步跳转
    Route::any('/returnpay','Index\RegController@returnpay');
    //支付宝异步跳转
    Route::any('/notify','Index\RegController@notify');
    //退出登录
    Route::any('/tuichu','Index\RegController@tuichu');
});
